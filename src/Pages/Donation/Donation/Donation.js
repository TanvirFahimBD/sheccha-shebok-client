...
const Donation = () => {
  ...
  const stripePromise = loadStripe(
    "pk_test_51L6u7WFgsutIdwUugeM7fMavghMBwUs855h9IHnQ3hmApyvT3zYHbc2n2tZyg5nouYvbnDrPfU1z8k0NQivmQJ0I00NRC61XhE"
  );
      ...
      <Box className="my-5" sx={{ width: "100%" }}>
        <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
          <Grid item xs={6}>
            <img
              className="m-5"
              src="https://i.ibb.co/wWRybJ3/Payment-Information-bro.png"
              alt=""
              height="700px"
            />
          </Grid>
